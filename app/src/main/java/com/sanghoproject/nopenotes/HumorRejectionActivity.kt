...
class HumorRejectionActivity : AppCompatActivity() {
    ...
    private fun prepareHumorRejectionPhrases() {
        ...
        // 심부름 부탁 거절 멘트
        humorRejectionPhrases.add("🙅‍♂️  ️심부름 부탁 거절 멘트")
        ...
        humorRejectionPhrases.add("🏋️‍♂️ 다이어트 같이 하자는 요청 거절 멘트")
    ...
    private fun setupListView() {
        ...
        val adapter = object : ArrayAdapter<String>(
            ...
            humorRejectionPhrases
        ) {
            override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
                val view = super.getView(position, convertView, parent)
                val textView = view.findViewById<TextView>(android.R.id.text1)
                val text = humorRejectionPhrases[position]
                ...
                if (text.contains(Regex("[\uD83C-\uDBFF\uDC00-\uDFFF]|[\u2600-\u27FF]"))) {
                    ...
                    textView.setTypeface(textView.typeface, android.graphics.Typeface.BOLD) // 일반
                }
